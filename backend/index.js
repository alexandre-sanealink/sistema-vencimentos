...
// MUDANÇA PRINCIPAL: ESTAMOS USANDO 'Client' EM VEZ DE 'Pool'
const { Client } = pg;
...
// (O restante das rotas também será adaptado para este novo modelo de conexão)
// #region ROTAS RESTANTES
